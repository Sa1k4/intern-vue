        ...
        <el-main>
          ...
          <el-table :data="tableData" border stripe :header-cell-class-name="headerBg" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作"  width="300" align="center">
              <template slot-scope="scope">
                <el-button type="success" @click="detail(scope.row)">查看 <i class="el-icon-plus"></i></el-button>
                <el-button type="warning" @click="evaluate(scope.row)">评价 <i class="el-icon-s-order"></i></el-button>
                <el-button type="danger" @click="add(scope.row.stu_id)">删除 <i class="el-icon-minus"></i></el-button>
              </template>
            </el-table-column>
          </el-table>
  ...
  <script>
    ...
    export default {
      ...
      methods: {
        ...
        load(){
          this.request.get("/teacher/findStudent",{
            params: {
        ...
        add(id){
          this.request.get("/teacher/delStudent",{
            params:{
              t_id:this.userinfo.t_id,
              stu_id:id
            }
        ...
        addMultiple(){
          ...
          console.log(ids)
          this.request.post("/teacher/delStudentMultiple", ids).then(res =>{  
            if(res.code == 200){
              this.$message.success("删除成功")
              this.request.get("/teacher/findStudent",{
            params: {
        ...
        evaluate(res){
          ...
          this.form.t_id = this.userinfo.t_id
          this.request.post("/evaluate/selectEvaT",this.form).then(res =>{
        ...
        save(){
          ...
          if(this.SorI == "I")
          this.request.post("/evaluate/insertEvaT",this.form).then(res =>{
            if(res.code == 200){
          ...
          if(this.SorI == "S")
          this.request.post("/evaluate/updateEvaT",this.form).then(res =>{
            if(res.code == 200){
