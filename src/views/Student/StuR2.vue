<template>
    <el-container style="min-height: 100vh">
        ...
        >
          ...
          <el-menu-item index="/student">
            ...
            <el-submenu index="/2" v-if="(userinfo.apply==2)">
              ...
              <el-menu-item index="/studentR2" style="color:#39c5bb">实习周报</el-menu-item>
        ...
        <el-main>
          <div style="margin-bottom: 30px">
            <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item>实习周报</el-breadcrumb-item>
            </el-breadcrumb>
          </div>
      ...
      <el-dialog title="实习周报" :visible.sync="dialogFormVisible" width="35%">
    ...
    export default {
      ...
      methods: {
        ...
        save(){
          ...
          this.request.post("/student/stuWeek",this.form).then(res =>{
                if(res.code == 200){
