  ...
  <el-container style="min-height: 100vh">
      ...
      >
        ...
        <el-menu-item index="/student">
          ...
          <el-submenu index="/2" v-if="(userinfo.apply==2)">
            ...
            <el-menu-item index="/studentR4" style="color:#39c5bb">实习报告</el-menu-item>
          </el-submenu>
    ...
    <el-container>
      ...
      <el-main>
        ...
        <el-tab-pane label="实习报告" name="tab1">  
    ...
    <el-dialog title="实习报告" :visible.sync="dialogFormVisible" width="35%">
  ...
  export default {
    ...
    methods: {
      ...
      save(){
        ...
        this.request.post("/student/stuRepo",this.form).then(res =>{
              if(res.code == 200){
