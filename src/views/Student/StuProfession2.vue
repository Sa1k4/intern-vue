<template>
    <el-container style="min-height: 100vh">
        ...
        >
          ...
          <el-menu-item index="/student">
            ...
            <el-submenu index="/1">
              ...
              <el-menu-item index="/studentP2" style="color:#39c5bb">申请失败岗位</el-menu-item>
            </el-submenu>
            <el-submenu index="/2">
              <template slot="title">
        ...
        <el-main>
          <div style="margin-bottom: 30px">
            <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item>申请失败岗位</el-breadcrumb-item>
            </el-breadcrumb>
          </div>
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="申请失败岗位" name="tab1">  
          ...
          <el-table :data="tableData" border stripe :header-cell-class-name="headerBg">
            ...
            <el-table-column label="操作"  width="300" align="center">
              <template slot-scope="scope">
                ...
                <el-button v-if="(scope.row.status==1)" type="success" @click="apply(scope.row.id)">重新申请 <i class="el-icon-tickets"></i></el-button>
              </template>
            </el-table-column>
          </el-table>
  ...
  <script>
    ...
    export default {
      ...
      methods: {
        ...
        load(){
          this.request.get("/profession/selectPsOfNo",{
            params: {
