<template>
    <el-container style="min-height: 100vh">
        ...
        >
          ...
          <el-menu-item index="/student">
            ...
            <el-submenu index="/2" v-if="(userinfo.apply==2)">
              ...
              <el-menu-item index="/studentR1" style="color:#39c5bb">实习请假申请</el-menu-item>
        ...
        <el-main>
          <div style="margin-bottom: 30px">
            <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item>实习请假申请</el-breadcrumb-item>
            </el-breadcrumb>
          </div>
          <div style="margin: 10px 0">
            <el-button type="primary" size="small" @click="handleAdd">申请 <i class="el-icon-circle-plus-outline"></i></el-button> 
          </div>
          <el-tabs v-model="activeName">
          <el-tab-pane label="申请信息" name="tab1">  
          
            <el-table :data="tableData" border stripe :header-cell-class-name="headerBg">
            <el-table-column prop="content" label="请假原因">
            </el-table-column>
            <el-table-column prop="start_time" label="开始时间" width="120"> 
            </el-table-column>
            <el-table-column prop="end_time" label="结束时间" width="120"> 
            </el-table-column>
            <el-table-column prop="apply" label="申请状态" width="120">
              <template slot-scope="scope">
                <div v-if="(scope.row.apply==0)" style="color:orange">申请审核中</div>
                <div v-if="(scope.row.apply==2)" style="color:red">申请未通过</div>
                <div v-if="(scope.row.apply==1)" style="color:greenyellow">申请已通过</div>
              </template>
            </el-table-column>
      ...
      <el-dialog title="请假申请" :visible.sync="dialogFormVisible" width="35%">
  ...
  <script>
    ...
    export default {
      ...
      methods: {
        ...
        load(){
          this.request.get("/student/stuLeaveS",{
            params: {
              stu_id:this.userinfo.stu_id,
        ...
        save(){
          ...
          this.form.start_time = this.value[0];
          this.form.end_time = this.value[1];
          this.request.post("/student/stuLeaveI",this.form).then(res =>{
                if(res.code == 200){
